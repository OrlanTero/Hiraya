...
const MultiBookReturn = ({ 
  ...
  const fetchReturnableBooks = async () => {
    try {
      ...
      const books = await window.api.getReturnableBooks(memberId);
      console.log('API response for returnable books:', books);
  ...
  const handleReturnBooks = async () => {
    ...
    try {
      ...
      const result = await window.api.returnMultipleBooks(returnData);
